...
const StatModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'stat': PropertySchema(id: 3, name: r'stat', type: IsarType.double),
  },
...
extension StatModelByIndex on IsarCollection<StatModel> {
  Future<StatModel?> getByRegionDateTimeItemCode(
    ...
    return getByIndex(r'region_dateTime_itemCode', [
      region,
      dateTime,
      itemCode,
    ]);
  ...
  StatModel? getByRegionDateTimeItemCodeSync(
    ...
    return getByIndexSync(r'region_dateTime_itemCode', [
      region,
      dateTime,
      itemCode,
    ]);
  ...
  Future<bool> deleteByRegionDateTimeItemCode(
    ...
    return deleteByIndex(r'region_dateTime_itemCode', [
      region,
      dateTime,
      itemCode,
    ]);
  ...
  bool deleteByRegionDateTimeItemCodeSync(
    ...
    return deleteByIndexSync(r'region_dateTime_itemCode', [
      region,
      dateTime,
      itemCode,
    ]);
  ...
  Future<List<StatModel?>> getAllByRegionDateTimeItemCode(
    ...
    assert(
      dateTimeValues.length == len && itemCodeValues.length == len,
  ...
  List<StatModel?> getAllByRegionDateTimeItemCodeSync(
    List<Region> regionValues,
    List<DateTime> dateTimeValues,
    List<ItemCode> itemCodeValues,
  ) {
  ...
  Future<int> deleteAllByRegionDateTimeItemCode(
    List<Region> regionValues,
    List<DateTime> dateTimeValues,
    List<ItemCode> itemCodeValues,
  ) {
  ...
  int deleteAllByRegionDateTimeItemCodeSync(
    List<Region> regionValues,
    List<DateTime> dateTimeValues,
    List<ItemCode> itemCodeValues,
  ) {
  ...
  Id putByRegionDateTimeItemCodeSync(
    StatModel object, {
    bool saveLinks = true,
  }) {
    return putByIndexSync(
      r'region_dateTime_itemCode',
      object,
      saveLinks: saveLinks,
    );
  }
  ...
  List<Id> putAllByRegionDateTimeItemCodeSync(
    List<StatModel> objects, {
    bool saveLinks = true,
  }) {
...
extension StatModelQueryWhere
  ...
  QueryBuilder<StatModel, StatModel, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<StatModel, StatModel, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<StatModel, StatModel, QAfterWhereClause>
  regionGreaterThanAnyDateTimeItemCode(Region region, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'region_dateTime_itemCode',
  ...
  QueryBuilder<StatModel, StatModel, QAfterWhereClause>
  regionLessThanAnyDateTimeItemCode(Region region, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'region_dateTime_itemCode',
  ...
  QueryBuilder<StatModel, StatModel, QAfterWhereClause>
  regionEqualToDateTimeNotEqualToAnyItemCode(Region region, DateTime dateTime) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
...
extension StatModelQueryFilter
  ...
  QueryBuilder<StatModel, StatModel, QAfterFilterCondition> itemCodeEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'itemCode', value: value),
      );
    });
  }
  ...
  QueryBuilder<StatModel, StatModel, QAfterFilterCondition> regionEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'region', value: value),
      );
    });
  }
